...
# This was copied from https://github.com/bazelbuild/bazel/blob/master/scripts/bazel-run.sh
# as a workaround for https://github.com/bazelbuild/bazel/issues/2337
